...
* **Slow-Cortical Potentials (SCPs)**
  ...
  2. [Freewill Reaching and Grasping EEG Dataset](https://figshare.com/articles/dataset/A_Large_Electroencephalogram_Database_of_Freewill_Reaching_and_Grasping_Tasks_for_Brain_Machine_Interfaces/28632599): 23 participants completed 6,808 freewill reaching-and-grasping trials across 49 recording sessions. The paradigm incorporates both self-paced movement initiation and self-selection of one of four target objects, allowing participants to freely decide what movement to perform and when to initiate it. The dataset includes 31-channel EEG, four-channel EOG, three-axis accelerometer signals, and synchronized event annotations, making it suitable for studying slow cortical potentials associated with voluntary (or freewill) movement preparation and initiation. [[Article]](https://www.nature.com/articles/s41597-025-06039-9) [[Download Data]](https://figshare.com/articles/dataset/A_Large_Electroencephalogram_Database_of_Freewill_Reaching_and_Grasping_Tasks_for_Brain_Machine_Interfaces/28632599)
